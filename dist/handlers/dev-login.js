...
export async function devLoginHandler(request) {
    ...
    const response = NextResponse.json({
        ...
        explanation: {
            ...
            production_equivalent: "oauth2-proxy sets an encrypted _oauth2_proxy cookie, " +
...
export async function devLogoutHandler(request) {
